...
from source.data_etl.questionnaires_metadata.stepped_care.scores.scores_loader import ScoresLoader
...
from source.data_etl.questionnaires_metadata.info_objects import QuestionnairesList, QuestionnaireInfo, QuestionInfo
...
class QuestionnaireLoader:
    ...
    def _create_questionnaire_info_entry(self, questionnaire_name, items):
        ...
        if self.participant_types_map.get(questionnaire_name) is not None:
            participant_type = self.participant_types_map.get(questionnaire_name)['participant_type']
            parallel_questionnaire = self.participant_types_map.get(questionnaire_name)['parallel']
        else:
            participant_type = None
            parallel_questionnaire = None
        ...
        'parallel_questionnaire': parallel_questionnaire,
