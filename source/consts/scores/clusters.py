...
Clusters = {
    ...
    Questionnaire.sdq: SDQ_clusters,
    Questionnaire.erq_m: {
    ...
    Questionnaire.erq_f: {
        'Cognitive Reappraisal': ['erq_1_f', 'erq_3_f', 'erq_5_f', 'erq_7_f', 'erq_8_f', 'erq_10_f'],
        'Expressive Suppression': ['erq_2_f', 'erq_4_f', 'erq_6_f', 'erq_9_f'],
    },
    ...
    Questionnaire.wai_immirisk_clin: {
    ...
    Questionnaire.c_ssrs_intake:{
        'cssrs_score': ['c_ssrs_1_life', 'c_ssrs_2_life', 'c_ssrs_3_life',
                   'c_ssrs_4_life', 'c_ssrs_5_life', 'c_ssrs_6_life'],
        'c_ssrs_intake_2weeks_score': ['c_ssrs_1_2weeks', 'c_ssrs_2_2weeks',
                                 'c_ssrs_3_2weeks', 'c_ssrs_4_2weeks',
                                 'c_ssrs_5_2weeks', 'c_ssrs_6_2weeks'],
    },
}
