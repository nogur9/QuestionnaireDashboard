...
Scores_Columns = {
    ...
    Questionnaire.cdrsr_clin: DEFAULT,  # V   -  not cdrs_sum_clin

    Questionnaire.cgi_s_clin: ['cgi_s_base_clin'],
    # V   There is a column named - cgi_s_clin, in the opening questionnaire, might be confusing
    Questionnaire.chameleon: ['chameleon_follow_stu',
                              'treatment_end_stu',
    ...
    Questionnaire.cps_clin: DEFAULT,  # V
    Questionnaire.cps_stu: DEFAULT,
    Questionnaire.c_ssrs_intake: [
        'c_ssrs_1_life',
        'c_ssrs_2_life',
        'c_ssrs_3_life',
        'c_ssrs_4_life',
    ...
    Questionnaire.cts_c: [
        ...
        'cts_c_3',
        'cts_c_4'],  # V
    Questionnaire.cts_m: DEFAULT,
    Questionnaire.cts_f: DEFAULT,

    Questionnaire.cyberbulling: [  # V
    ...
    Questionnaire.ders: [
        ...
        'ders_35',
        'ders_36'],  # V
    Questionnaire.ders_p_m: DEFAULT,  # V
    Questionnaire.ders_p_f: DEFAULT,  # V
    Questionnaire.dshi_pre: DEFAULT,  # V
    Questionnaire.dshi_post: DEFAULT,  # V
    ...
    Questionnaire.estimation_and_satisfaction: ['satis_1', 'satis_2','satis_3'],
    Questionnaire.erc_rc: [
        'erc_rc_1', 'erc_rc_2', 'erc_rc_3',
        'erc_rc_4', 'erc_rc_5', 'erc_rc_6',
        'erc_rc_7', 'erc_rc_8', 'erc_rc_9',
        'erc_rc_10', 'erc_rc_11', 'erc_rc_12'],  # V

    Questionnaire.erq_m: DEFAULT,  # V
    Questionnaire.erq_ca: [  # V
        'erq_ca_1', 'erq_ca_2',
        'erq_ca_3', 'erq_ca_4',
        'erq_ca_5',
        'erq_ca_6', 'erq_ca_7',
    ...
    Questionnaire.inq: [
        'inq_1', 'inq_2', 'inq_3', 'inq_4', 'inq_5', 'inq_6', 'inq_7', 'inq_8',
            'inq_9', 'inq_10', 'inq_11', 'inq_12', 'inq_13', 'inq_14', 'inq_15'], # V
    ...
    Questionnaire.maris_y_scars_clin: DEFAULT,  # V
    Questionnaire.maris_sci_sf: [
        'maris_sci_sf_1',
        'maris_sci_sf_2',
        'maris_sci_sf_3',
        'maris_sci_sf_4',
        'maris_sci_sf_5',
        'maris_sci_sf_6', 'maris_sci_sf_7', 'maris_sci_sf_8',
        'maris_sci_sf_9'],  # missing Score
    Questionnaire.maris_soq_sf: [
        'maris_soq_sf_1',
        'maris_soq_sf_2',
        'maris_soq_sf_3',
        'maris_soq_sf_4',
        'maris_soq_sf_5', 'maris_soq_sf_6', 'maris_soq_sf_7', 'maris_soq_sf_8'],  # missing Score
    Questionnaire.mfq: [
        'mfq_1',
        'mfq_2',
        'mfq_5',
        ...
        'mfq_30',
        'mfq_31'],  # v
    Questionnaire.moas_m: DEFAULT,  # V
    # split to mother and father

    Questionnaire.piu: [
        'piu_1', 'piu_2', 'piu_3', 'piu_4', 'piu_5', 'piu_6'],
    ...
    Questionnaire.sdq_parents_m: DEFAULT,  # V
    Questionnaire.siq: [
    'siq_1',
    'siq_2',
    'siq_3',
    ...
    Questionnaire.trq_sf_maris_clin: [
        'trq_sf_maris_1_clin',
        'trq_sf_maris_2_clin',
        'trq_sf_maris_3_clin',
        'trq_sf_maris_4_clin',
    ...
    Questionnaire.trq_sf_maris_stu: [
        'trq_sf_maris_1_stu',
        'trq_sf_maris_2_stu',
        'trq_sf_maris_3_stu',
        'trq_sf_maris_4_stu',
    ...
    Questionnaire.wai_immirisk_clin: DEFAULT,
    Questionnaire.wai: ['wai_1', 'wai_2', 'wai_3', 'wai_4',  # V
