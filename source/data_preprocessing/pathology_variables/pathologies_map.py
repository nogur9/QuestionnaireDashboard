...
PathologiesMap = {
    ...
    "self_harm_intake": PathologyVariable('self_harm', self_harm_intake,
                                            only_intake_evaluation=True),
    "suicidal_ideation_intake": PathologyVariable('suicidal_ideation',suicidal_ideation_life_intake,
                                            only_intake_evaluation=True),
    ...
    "NSSI_follow-up": PathologyVariable('NSSI', nssi_time2,
                                            only_follow_up_evaluation=True),
    "suicidal_ideation_follow_up": PathologyVariable('suicidal_ideation',suicidal_ideation_time2,
                                            only_follow_up_evaluation=True),
}
